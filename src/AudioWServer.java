 ...
 */
public class AudioWServer extends Thread {
    ...
    public AudioWServer(int audioPort) {
    ...
    public static int receiveJSON(JsonObject obj) {
        ...
        micBufferManager = new MicBufferManager(length, channel, encoding, rate);
        micBufferManager.setOnDataListener(dataListener);
